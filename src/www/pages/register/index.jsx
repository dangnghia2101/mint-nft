        ...
        <div class="register">
            ...
            <form>
                <div class="form-control">
                    ...
                    <input class="right-colum" type="text" name="firstname" id="firstname" />
                </div>
                <div class="form-control">
                    <label class="left-column label-control">Last Name </label>
                    <input class="right-colum" type="text" name="lastname" id="lastname" />
                </div>
                <div class="form-control">
                ...
                <div class="form-control">
                    ...
                    <input class="right-colum" type="date" name="birthday" id="birthday" />
                </div>
                <div class="form-control">
